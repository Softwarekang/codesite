...
func main() {
	f, err := os.Create("/Users/10029528/project/github/codesite/knetty/pprof/knetty.prof")
	if err != nil {
		log.Fatal(err)
	}
	f1, err := os.Create("/Users/10029528/project/github/codesite/knetty/pprof/knetty_m.prof")
	if err != nil {
		log.Fatal(err)
	}
